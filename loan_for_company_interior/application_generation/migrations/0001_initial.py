    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_employment', models.CharField(blank=True, choices=[('', '')], default=0, max_length=250)),
                ('business_title', models.CharField(blank=True, default=0, max_length=250)),
                ('business_type', models.CharField(blank=True, choices=[('', '')], default=0, max_length=250)),
